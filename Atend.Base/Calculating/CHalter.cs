...
namespace Atend.Base.Calculating
{
    public class CHalter
    {
        ...
        public bool AccessInsert()
        {
            ...
            OleDbCommand insertCommand = new OleDbCommand("C_Halter_Insert", con);
            ...
            {
                ed.WriteMessage(string.Format("Error cHalter.AccessInsert : {0} \n", ex.Message));
                con.Close();
                return false;
            }
        }
        ...
        public static DataTable AccessSelectBySectionCode(Guid SectionCode,bool IsUTS)
        {
            ...
            OleDbDataAdapter adapter = new OleDbDataAdapter("C_Halter_SelectBySectionCode", connection);
        ...
        {
            OleDbConnection connection = new OleDbConnection(Atend.Control.ConnectionString.AccessCnString);
            OleDbDataAdapter adapter = new OleDbDataAdapter("C_Halter_SelectByIsUTS", connection);
            adapter.SelectCommand.CommandType = CommandType.StoredProcedure;
            adapter.SelectCommand.Parameters.Add(new OleDbParameter("iIsUTS", IsUTS));
        ...
        public static bool AccessDelete()
        {
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
            OleDbConnection Connection = new OleDbConnection(Atend.Control.ConnectionString.AccessCnString);
            OleDbCommand Command = new OleDbCommand("C_Halter_Delete", Connection);
            ...
            {
                ed.WriteMessage(string.Format("Error CHalter.AccessDelete : {0} \n", ex1.Message));
                Connection.Close();
                return false;
            }
        }
        ...
        public static bool AccessDeleteBySectionCode(Guid SectionCode,bool IsUTS)
        {
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
            OleDbConnection Connection = new OleDbConnection(Atend.Control.ConnectionString.AccessCnString);
            OleDbCommand Command = new OleDbCommand("C_Halter_DeleteBySectionCode", Connection);
            Command.CommandType = CommandType.StoredProcedure;
