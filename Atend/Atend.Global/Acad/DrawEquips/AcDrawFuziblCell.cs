...
{
    public class AcDrawFuziblCell
    {

        //~~~~~~~~~~~~~~~~~~~~~~ class ~~~~~~~~~~~~~~~~~~//


    //    private class DrawFuziblCellCellJig : DrawJig
    //    {
    ...
    //        public DrawFuziblCellCellJig(int CurrentProductCode, Guid Code, double Scale)
    //        {
    //            MyScale = Scale;
    ...
    //            //additional lines
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X, _CenterPoint.Y + 30, _CenterPoint.Z), new Point3d(_CenterPoint.X, _CenterPoint.Y + 25, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 5, _CenterPoint.Y + 25, _CenterPoint.Z), new Point3d(_CenterPoint.X + 5, _CenterPoint.Y + 25, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X, _CenterPoint.Y + 10, _CenterPoint.Z), new Point3d(_CenterPoint.X, _CenterPoint.Y, _CenterPoint.Z), 0, 0, 0));

    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X, _CenterPoint.Y - 20, _CenterPoint.Z), new Point3d(_CenterPoint.X, _CenterPoint.Y - 25, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 5, _CenterPoint.Y, _CenterPoint.Z), new Point3d(_CenterPoint.X + 5, _CenterPoint.Y, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X + 5, _CenterPoint.Y, _CenterPoint.Z), new Point3d(_CenterPoint.X + 5, _CenterPoint.Y - 20, _CenterPoint.Z), 0, 0, 0));

    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X + 5, _CenterPoint.Y - 20, _CenterPoint.Z), new Point3d(_CenterPoint.X - 5, _CenterPoint.Y - 20, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 5, _CenterPoint.Y - 20, _CenterPoint.Z), new Point3d(_CenterPoint.X - 5, _CenterPoint.Y, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 5, _CenterPoint.Y - 5, _CenterPoint.Z), new Point3d(_CenterPoint.X - 10, _CenterPoint.Y - 5, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 10, _CenterPoint.Y - 5, _CenterPoint.Z), new Point3d(_CenterPoint.X - 10, _CenterPoint.Y + 15, _CenterPoint.Z), 0, 0, 0));

    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 10, _CenterPoint.Y + 15, _CenterPoint.Z), new Point3d(_CenterPoint.X - 5, _CenterPoint.Y + 15, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 5, _CenterPoint.Y + 15, _CenterPoint.Z), new Point3d(_CenterPoint.X - 7.5, _CenterPoint.Y + 17.5, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 5, _CenterPoint.Y + 15, _CenterPoint.Z), new Point3d(_CenterPoint.X - 7.5, _CenterPoint.Y + 12.5, _CenterPoint.Z), 0, 0, 0));

    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 10, _CenterPoint.Y - 10, _CenterPoint.Z), new Point3d(_CenterPoint.X + 10, _CenterPoint.Y, _CenterPoint.Z), 0, 0, 0));
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X - 10, _CenterPoint.Y - 15, _CenterPoint.Z), new Point3d(_CenterPoint.X + 10, _CenterPoint.Y - 5, _CenterPoint.Z), 0, 0, 0));
    ...
    //            //keys
    //            Entities.Add(CreateLine(new Point3d(_CenterPoint.X + 5, _CenterPoint.Y + 20, _CenterPoint.Z), new Point3d(_CenterPoint.X, _CenterPoint.Y + 10, _CenterPoint.Z), (int)Atend.Control.Enum.ProductType.Key, 150, 0));
    ...
    //    }
        ...
        public class DrawFuziblCellCellJig02 : DrawJig
        {
            List<Entity> Entities = new List<Entity>();
            Point3d CenterPoint = Point3d.Origin;
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
            ...
            public DrawFuziblCellCellJig02(int CurrentProductCode, Guid Code, double Scale)
            {
                MyScale = Scale;
                ProductCode = CurrentProductCode;
                CodeGuid = Code.ToString();
