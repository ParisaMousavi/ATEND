...
namespace Atend.Global.Acad.DrawEquips
{
    ...
    public class AcDrawCirclePole
    {
        ...
        class DrawPoleCircleJig : DrawJig
        {
            ...
            public DrawPoleCircleJig(int _ConsolCount, double Scale)
            {
                ...
                Entities.Add(DrawCirclePole(CenterPoint));
            ...
            private Entity DrawCirclePole(Point3d BasePoint)
            {

                Atend.Global.Acad.AcadJigs.MyCircle MyCir = new Atend.Global.Acad.AcadJigs.MyCircle();
                MyCir.Radius = 50;
                MyCir.Center = BasePoint;
                MyCir.Normal = Vector3d.ZAxis;

                Atend.Global.Acad.AcadJigs.SaveExtensionData(MyCir, (int)Atend.Control.Enum.ProductType.Pole);
                return MyCir;


            }

            public Entity DrawConsol(Point3d BasePoint, double Width, double Height)
            {
        ...
        //public bool DrawPoleCircle(Point3d CenterPoint, double Angle)
        //{
        //    Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
        //    ResetClass();
        ...
        //            int i = 0;
        //            DrawPoleCircleJig poleCircle = new DrawPoleCircleJig(eConsols.Count, MyScale);
        //            List<Entity> entities = poleCircle.GetDemo(CenterPoint, Angle);
        ...
        //                    Atend.Global.Acad.AcadJigs.MyCircle myCircle;
        //                    Atend.Global.Acad.AcadJigs.MyPolyLine myPoly;

        //                    myCircle = ent as Atend.Global.Acad.AcadJigs.MyCircle;

        //                    if (myCircle == null)
        //                    {
        //                        myPoly = ent as Atend.Global.Acad.AcadJigs.MyPolyLine;
        //                        if (myPoly == null)
        //                        {
        //                            return false;
        //                        }
        ...
        //                    else
        //                    {
        //                        if (myCircle.AdditionalDictionary.ContainsKey("ProductType"))
        //                        {
        //                            myCircle.AdditionalDictionary.TryGetValue("ProductType", out productType);
        //                        }
        //                        else
        //                        {
        //                            return false;
        ...
        //                    //ed.WriteMessage(productType.ToString() + "\n");
        ...
        //                        //Atend.Base.Acad.AT_SUB.AddToAT_SUB(TextOi, ent.ObjectId);
        ...
        //                        // Atend.Base.Equipment.EConsol.SelectByCodeForDesign(package.ProductCode);
        ...
        //                            Atend.Base.Acad.AT_SUB textSub = new Atend.Base.Acad.AT_SUB(TextOi);
        //                            at_sub.SubIdCollection.Add(NewConsolObjectID);
        //                            at_sub.Insert();
        ...
        public bool DrawPoleCircle(Point3d CenterPoint, double Angle, out ObjectIdCollection NewDrawnNodes)
        {
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
        ...
        public void DrawPoleCircle()
        {
            ...
            using (DocumentLock docLock = Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument.LockDocument())
            {
                ...
                while (conti)
                {
                    ...
                    {
                        if (!Atend.Global.Acad.DrawEquips.AcDrawForbidenArea.PointWasInForbidenArea(poleCircle.PoleCenterPoint))
                        {
                            conti = false;
        ...
        public static void RotatePoleCircle(double NewAngleDegree, Guid PoleCode)
        {
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
        ...
        private bool SavePoleData()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (eHalterCount != 0)
                    {
                        ...
                        {
                            throw new System.Exception("eHalter.AccessInsert failed");
                        }
                    }
            ...
            //UseAccess = true;
            for (int i = 0; i < Atend.Base.Acad.AcadGlobal.CirclePoleData.eConsolUseAccess.Count; i++)
            {
                Atend.Base.Acad.AcadGlobal.CirclePoleData.eConsolUseAccess[i] = true;
            }
        ...
        public void DrawPoleCircleTip(Point3d CenterPoint, double Angle)
        {
        ...
        private bool SavePoleDataTip()
        {
            ...
            //ed.WriteMessage("~~~~~~~~~~~~~ Start Save PoleTip Data ~~~~~~~~~~~~~~~~~~\n");
            //ed.WriteMessage("~~{0}~~\n",Atend.Control.ConnectionString.AccessCnString);
            OleDbConnection aConnection = new OleDbConnection(Atend.Control.ConnectionString.AccessCnString);
            OleDbTransaction aTransaction;
            ...
            //ed.WriteMessage("~~~~~~~~~~~~~ End Save Pole DataTip ~~~~~~~~~~~~~~~~~~\n");
        ...
        //            HalterPackage.Number = string.Empty;// string.Format("P{2}-{0:00}{1:00}", Math.Round(ePole.Power / 100, 0), Math.Round(ePole.Height, 0), Atend.Control.Common.Counters.PoleCounter);
