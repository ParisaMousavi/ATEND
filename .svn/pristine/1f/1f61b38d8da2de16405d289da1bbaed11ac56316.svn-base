...
namespace Atend.Design
{
    public partial class frmSetting : Form
    {
        ...
        private void ذخیرهسازیToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (Validation())
            {
                ...
                if (Atend.Control.ConnectionString.ConnectionValidation(strconnection))
                    Atend.Control.ConnectionString.LocalcnString = strconnection;
                //WriteToConfig("LocalConnectionString", strconnection);
            }
            else
            {
        ...
        private void frmSetting_Load(object sender, EventArgs e)
        {
            ...
            string CNS = Atend.Control.ConnectionString.LocalcnString;
        ...
        private void cboMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument.Editor.WriteMessage("1\n");
        }
