...
{
    public class AcDrawReleCell
    {


    //    private class DrawReleCellJig : DrawJig
    //    {
    ...
    //        public DrawReleCellJig(int CurrentProductCode, Guid Code, double Scale)
    //        {
    //            MyScale = Scale;
    ...
    //    }
        ...
        public class DrawReleCellJig02 : DrawJig
        {
            List<Entity> Entities = new List<Entity>();
            Point3d CenterPoint = Point3d.Origin;
            Editor ed = Application.DocumentManager.MdiActiveDocument.Editor;
            ...
            public DrawReleCellJig02(int CurrentProductCode, Guid Code, double Scale)
            {
                MyScale = Scale;
                CodeGuid = Code.ToString();
                ProductCode = CurrentProductCode;
